  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          owner: commentEntity?.owner?.id,
          likes: commentEntity?.likes?.map(e => e.id.toString()),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ivanstagramApp.comment.home.createOrEditLabel" data-cy="CommentCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField id="comment-owner" name="owner" data-cy="owner" label="Owner" type="select" required>
                <option value="" key="0" />
                {users
              ...
              <ValidatedField label="Like" id="comment-like" data-cy="like" type="select" multiple name="likes">
                <option value="" key="0" />
                {users
                  ? users.map(otherEntity => (
                      <option value={otherEntity.id} key={otherEntity.id}>
